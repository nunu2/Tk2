...
settings = {
    ...
    "KIEBOT1":"\n[ดีครับคนมาใหม่... ]",
    "KIEBOT2":"\n[บายยย  แล้วพบกัน..]",
    "tag1":"\n[ถ้าจะแทคขนาดนี้เอาเราไปทำผัวเลยดีมั๊ย]",
    "tag2":"\n[ผู้ใช้รายนี้ยังไม่ว่าง ว่าวยุ กรุนาติดต่อใหม่ภายหลังค่ะ ขอบคุณ]",
    "blacklist":{},
    "winvite": False,
    "wblacklist": False,
    "dblacklist": False,
    ...
    "pname": {},
    "pro_name": {},
    "message":"คุณไม่สามารถเพิ่มเพื่อนได้/nเนื่องจากคุณไม่ได้รับอนุญาติจาก ༄۞ꪶꪶꪣꪫꪊุ۞࿐ /nขอบคุณที่แอดมา (◡‿◡✿)\n •*´¨`*•.¸¸.•*´¨`*•.¸¸.•*´¨`*•.¸¸.•*´¨`*•.¸¸.•\n::: (\_(\ …*…*…*…*…*…*…*…*…::::::::::::::\n*: (=’ :’) :: ออโต้บล็อค  นะจ๊ะ! :::::::::::::::::::::\n•.. (,(”)(”)¤…*…*…*…*…*…*…*…*…:::::::::::\n¸.•*´¨`*•.¸¸.•*´¨`*•.¸¸.•*´¨`*•.¸¸.•*´¨`*•.¸",
...
def myhelp():
    myHelp = "✰「  SELFBOT ༄۞ꪶꪶꪣꪫꪊุ۞࿐ 」✰   " + "\n" \
                  ...
                  "۞~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~۞" + "\n" + \
                  "❄「༄۞ꪶꪶꪣꪫꪊุ۞࿐」❄" + "\n" + \
                  "❄「@ID. http://line.me/ti/p/p-nunu_kap123 」❄" + "\n" + \
                  "❄════"
    return myHelp
